...
\hypersetup{
  ...
  pdfauthor={Jordan Gunn; Sean Polyn},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Project Name}
\author{Jordan Gunn \and Sean Polyn}
\date{}

\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, frame hidden, boxrule=0pt, enhanced, interior hidden, borderline west={3pt}{0pt}{shadecolor}, breakable]}{\end{tcolorbox}}\fi
...
\hypertarget{quarto-template}{%
\chapter{quarto-template}\label{quarto-template}}
...
\hypertarget{example-main-markdown-document}{%
\chapter{Example Main Markdown
Document}\label{example-main-markdown-document}}

Let's demo adding an arbitrary reference (Morton \& Polyn, 2016).

\part{Library Functions}

\hypertarget{example-library-notebook}{%
\chapter{Example Library Notebook}\label{example-library-notebook}}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{plot_polar}{%
\subsection{plot\_polar}\label{plot_polar}}
...
\includegraphics{src/library/01_example_files/figure-pdf/cell-5-output-1.png}
