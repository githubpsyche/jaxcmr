...
from jaxcmr.models.weird_drift_position_scale_cmr import BaseCMRFactory as model_factory
...
data_query = "jnp.logical_and(data['recall_attempt'] == 1, data['recall_total'] > 0)"
data_path = "data/KahanaJacobs2000.h5"
run_tag = "full_best_of_3"

# fitting params
redo_fits = False
model_name = "DriftPositionScaleCMR"
...
diff_w = 0.85
best_of = 3
target_dir = "projects/KahanaJacobs2000"
...
parameters = {
    ...
    "free": {
        ...
        "repetition_drift_rate": [2.220446049250313e-16, 0.9999999999999998],
