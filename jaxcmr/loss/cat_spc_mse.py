...
class MemorySearchCatSpcMseFnGenerator:
    ...
    def __init__(
        ...
        # Prepare PRNG keys for shared and per-trial simulations.
        ...
        # Precompute observed category recall frequencies and masks per condition.
        ...
        # Build recall-length masks to truncate simulated recalls at observed totals.
