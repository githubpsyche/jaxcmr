...
class MemorySearchLikelihoodFnGenerator:
    ...
    def __init__(
        ...
        """
        # cache factory helpers and dataset metadata
        ...
        # reindex observed recalls so they align with the presentation indices
        ...
        # bag counts and totals for each trial
        ...
        # shared keys for identical-presentation branch
        ...
        # per-trial key batches for general case
    ...
    def estimate_bag_probability(
        ...
        trial_totals = self.trial_totals[trial_index]

        def simulate_and_match(key: PRNGKeyArray) -> Bool[Array, ""]:
            _, recalls = simulate_free_recall_count(
                model, trial_totals, self.list_length, key
            )
