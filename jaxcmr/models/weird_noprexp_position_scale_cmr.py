...
class CMR(Pytree):
    ...
    def experience_item(self, item_index: Int_) -> "CMR":
        ...
        return self.replace(
            context=new_context,
            mfc=intermediate_mfc.associate(mfc_cue, self.context.state, self.mfc_learning_rate), #!
            mcf=intermediate_mcf.associate(self.context.state, mfc_cue, self.mcf_learning_rate), #! 
