"""
Study Reinforcement Positional CMR.
...
When an item is re-presented, its first presentation's pre-experimental context is reinforced.
...
class CMR(Pytree):
    ...
    def __init__(
        ...
        self.first_presentation_reinforcement = parameters["first_presentation_reinforcement"]
        ...
        #! a separate pre-exp mfc for retrieving full input during reinforcement
    ...
    def experience_item(self, item_index: Int_) -> "CMR":
        ...
        new_mfc = lax.cond(
            ...
            lambda: self.mfc.associate(
                item_studied, associated_context, self.first_presentation_reinforcement
            ),
            lambda: self.mfc
        )
        new_mcf = lax.cond(
            ...
            lambda: self.mcf.associate(
                associated_context, item_studied, self.first_presentation_reinforcement
            ),
            lambda: self.mcf
        )
        ...
        return self.replace(
            ...
            mfc=new_mfc.associate(mfc_cue, learning_state, self.mfc_learning_rate),
            mcf=new_mcf.associate(learning_state, mfc_cue, self.mcf_learning_rate),
