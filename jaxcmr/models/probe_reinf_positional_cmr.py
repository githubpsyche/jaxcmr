"""Positional CMR with probe reinforcement.
...
class CMR(Pytree):
    ...
    def experience_item(self, item_index: Int_) -> "CMR":
        ...
        #! if studied item has been studied before, we reinforce the first probed context
        ...
        associated_context = self.mfc.probe(first_item_studied)
        new_mcf = lax.cond(
            already_studied,
