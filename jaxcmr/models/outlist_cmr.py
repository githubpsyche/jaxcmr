...
class CMR(Pytree):
    ...
    def __init__(
        ...
        #! uses init_expanded for expanded context representation
        context_create_fn: ContextCreateFn = TemporalContext.init_expanded,
        ...
        #! mfc_sensitivity used to scale context input for repeated items
    ...
    def experience_item(self, item_index: Int_) -> "CMR":
        ...
        #! We use integrate_with_outlist if self.recallable[item_index] is already True
        #! (which corresponds to the item having already been encoded before)
