...
class RepCRPTabulation(Pytree):
    """Tabulate backward repetition lag transitions.
    ...
    def tabulate_actual_lags(self, recall: Int_) -> Integer[Array, " lags"]:
        ...
        return self.actual_lags + new_lags.sum(1)
...
def repcrp(
    ...
    actual, possible = vmap(tabulate_trial, in_axes=(0, 0, None, None))(
        recalls, presentations, min_lag, size
    )
...
def plot_back_rep_crp(
    ...
    -------
    Axes
        Axes with the backward repetition CRP plot.
...
def plot_difference_rep_crp(
    ...
    """Plot first-minus-second backward repetition CRP.
