"""Compute intrusion error rates and plot them."""
...
def trial_intrusion_error_rate(
    ...
    """Returns intrusion flags for a single trial.
    ...
    Args:
        ...
        size: The number of studied items in each trial. Unused, included for compatibility.
    """
...
def intrusion_error_rate(
    ...
    """Returns mean intrusion rate by study position across trials.
    ...
    Args:
        ...
        list_length: Length of the study list. Unused, included for compatibility.
        size: Number of studied items in each trial. Unused, included for compatibility.
    """
...
def plot_intrusion_error_rate(
    ...
    """Plot intrusion error rate across study positions.

    Args:
        datasets: Datasets containing trial data to plot.
