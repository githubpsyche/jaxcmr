...
class BaseCMR(CMR, mutable=True):
    ...
    def create(
        ...
        return cls(
            item_count, presentation_count, encoding_drift_rate, delay_drift_rate, 
            start_drift_rate, recall_drift_rate, shared_support, item_support, learning_rate, 
            primacy_scale, primacy_decay, stop_probability_scale, stop_probability_growth, 
            choice_sensitivity
            )
    ...
    def create(
        ...
        return cls(
            item_count, presentation_count, parameters['encoding_drift_rate'], 
            parameters['delay_drift_rate'], parameters['start_drift_rate'],
            parameters['recall_drift_rate'], parameters['shared_support'],
            parameters['item_support'], parameters['learning_rate'],
            parameters['primacy_scale'], parameters['primacy_decay'],
            parameters['stop_probability_scale'], parameters['stop_probability_growth'],
