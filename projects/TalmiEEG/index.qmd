...
As shown in @fig-corec_by_lag, co-recall probabilities are highest for short lags and decline monotonically with increasing separation, indicating that recall sets are temporally clustered even when we ignore output order. P
...
@fig-cat_lpp_by_recall_split rules out two attractive accounts of how LPP relates to item type and recall.
...
The second attractive account is that LPP reflects recall probability: items with higher LPPs are more likely to be recalled, regardless of item type.
