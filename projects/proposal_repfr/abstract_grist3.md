...
We re-examined free- and serial-recall datasets with matched control baselines.
...
Retrieved-context theory (RCT) predicts that repetitions knit contexts together: when an item is encoded or retrieved, it reinstates features from prior occurrences, creating blended cues.
