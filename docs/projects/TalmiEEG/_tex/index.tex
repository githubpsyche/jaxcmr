...
\includegraphics{results/figures/daw_meeting_slide5.png}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/reference_catspc.png}\end{minipage}%
...
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/cat_lpp_spc_EarlyLPP.png}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/cat_lpp_spc_LateLPP.png}\end{minipage}%
...
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/cat_lpp_by_recall_EarlyLPP_Negative.png}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/cat_lpp_by_recall_EarlyLPP_Neutral.png}\end{minipage}%
\newline
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/cat_lpp_by_recall_LateLPP_Negative.png}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/cat_lpp_by_recall_LateLPP_Neutral.png}\end{minipage}%
...
\includegraphics{results/figures/cat_lpp_by_recall.png}
...
\includegraphics{results/figures/reference_gmm.png}
...
(Healey and Kahana 2014): 126 participants aged 17--30 completed 112
trials in which they studied lists of 16 unique words and then
immediately recalled them. Words were sampled without replacement from
the Toronto Word Pool (Friendly et al. 1982), a set of high-frequency
nouns, adjectives, and verbs with low interitem similarity. The left
panel of Figure~\ref{fig-peers_lagcrp_condcorec} shows the standard
lag-CRP for this dataset, with a strong contiguity effect: recall
transitions are most likely at lag +1, somewhat less likely at lag −1,
and fall off rapidly for larger \(|lag|\). The right panel shows the
corresponding conditional co-recall curve \(\text{CoRec}(d)\), collapsed
over lag sign. Conditional co-recall is highest for short lags and
decreases steadily with distance, closely mirroring the lag-CRP gradient
despite ignoring recall order. These results confirm that the
conditional co-recall analysis is sensitive to temporal contiguity when
it is present.

\begin{figure}

\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/peers_lagcrp.png}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/peers_condcorec_by_lag.png}\end{minipage}%
...
PEERS dataset (Healey and Kahana 2014). The conditional co-recall curve
reproduces the short-lag advantage observed in the lag-CRP despite not
using recall order information.}
...
\includegraphics{results/figures/analyses/zarubin_condcorec_by_lag.png}
...
eCMR.}\label{tbl-ecmr-parameters}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Symbol
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
We maximize the objective with differential evolution (Storn and Price
1997). Because differential evolution is stochastic, we run three
independent optimizations per participant and model variant and retain
the best-performing fit. For model comparison, we compute per-subject
AIC values and summarize mean \(\Delta\)AIC with t-based 95\% confidence
...
participants).}\label{tbl-talmi-parameter-estimates}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Parameter
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
CI{]}).}\label{tbl-talmi-delta-aic}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Emotion + LPP (main effects)
...
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/cat_lpp_by_recall.png}\end{minipage}%
...
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/fitting/TalmiEEG_EEGEmotionOnly_50_set_likelihood_fixed_term_best_of_3_cat_spc.png}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/fitting/TalmiEEG_EEGEmotionOnly_50_set_likelihood_fixed_term_best_of_3_cat_lpp_by_recall.png}\end{minipage}%
...
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/fitting/TalmiEEG_EEGMainEffects_50_set_likelihood_fixed_term_best_of_3_cat_spc.png}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/fitting/TalmiEEG_EEGMainEffects_50_set_likelihood_fixed_term_best_of_3_cat_lpp_by_recall.png}\end{minipage}%
...
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/fitting/TalmiEEG_EEGMainEffectsPlusInteraction_50_set_likelihood_fixed_term_best_of_3_cat_spc.png}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/fitting/TalmiEEG_EEGMainEffectsPlusInteraction_50_set_likelihood_fixed_term_best_of_3_cat_lpp_by_recall.png}\end{minipage}%
...
\includegraphics{results/figures/amplitude_by_cat_by_recalled.png}
...
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/reference_cat_recall_by_lpp.png}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/cat_recall_by_lpp_EarlyLPP.png}\end{minipage}%
...
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/cat_recall_by_lpp_EarlyLPP_counts.png}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\includegraphics{results/figures/analyses/cat_recall_by_lpp_LateLPP_counts.png}\end{minipage}%
